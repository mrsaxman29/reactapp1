...
export default function Projects() {
  ...
  const bsAPP_summary = "A full-stack baseball scoring & notation web app created using vanilla JS, HTML& CSS that employs firebase for the backend."
  ...
  const bs_app_tags = ["JS", "CSS", "HTML", "FIREBASE"]
